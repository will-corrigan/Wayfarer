...
/// what a press does, the icon drawn in front of those words, the game's own mark in front of the
/// line, and whether a press does anything.</summary>
...
/// <param name="IconId">A game icon drawn in front of the keyword, or null.</param>
