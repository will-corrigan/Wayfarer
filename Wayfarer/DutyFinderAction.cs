...
/// that distinction). One place for the one call every duty-gated "Go" affordance makes — the
/// guided-quest-in-a-duty line and the game's own context menu — so it is made exactly once rather
/// than reimplemented at each call site.</summary>
