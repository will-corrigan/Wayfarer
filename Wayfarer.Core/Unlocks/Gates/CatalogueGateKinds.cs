...
/// something: two of the eighteen kinds read data the client does not hold until it has been
...
{
    /// <summary>Every <c>kind</c> named anywhere in these definitions' requirement trees,
    /// including nested combinator children.</summary>
